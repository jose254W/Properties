...
const PropertyDetails = () => {
  ...
  const handleCall = () => {
    window.open("tel: 0700000000",  "_blank");
  }

  const handleEmail = () => {
    window.open("mailto:josewawe75@gmail.com", "_blank");
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <CustomButton
                title={!isCurrentUser ? "Email" : "Edit"}
                backgroundColor="#475BE8"
                color="#FCFCFC"
                fullWidth
                icon={!isCurrentUser ? <EmailIcon /> : <Edit />}
                handleClick={() => {
                  if (isCurrentUser) {
              ...
              <CustomButton
                ...
                handleClick={isCurrentUser ? handleDeleteProperty : handleCall}
              />
